...
// Syncing provides information when this nodes starts synchronising with the EthereumAI network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ethereumai.SyncProgress `json:"status"`
}
