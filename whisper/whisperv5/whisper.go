...
// Whisper represents a dark communication interface through the EthereumAI
...
// New creates a Whisper client ready to communicate through the EthereumAI P2P network.
