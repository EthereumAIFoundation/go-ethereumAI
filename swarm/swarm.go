...
import (
	...
	"github.com/ethereumai/go-ethereumai/contracts/chequebook"
	"github.com/ethereumai/go-ethereumai/contracts/ens"
	...
	"github.com/ethereumai/go-ethereumai/swarm/api"
	httpapi "github.com/ethereumai/go-ethereumai/swarm/api/http"
	"github.com/ethereumai/go-ethereumai/swarm/fuse"
	"github.com/ethereumai/go-ethereumai/swarm/network"
	"github.com/ethereumai/go-ethereumai/swarm/storage"
)
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := eaiclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := eaiclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
