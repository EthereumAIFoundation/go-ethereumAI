...
Section "Geai" GEAI_IDX
  ...
  SimpleFC::AdvRemoveRule "Geai incoming peers (TCP:40404)"
  SimpleFC::AdvRemoveRule "Geai outgoing peers (TCP:40404)"
  SimpleFC::AdvRemoveRule "Geai UDP discovery (UDP:40404)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geai incoming peers (TCP:40404)" ""  6 1 1 2147483647 1 "$INSTDIR\geai.exe" "" "" "EthereumAI" 40404 "" "" ""
  SimpleFC::AdvAddRule "Geai outgoing peers (TCP:40404)" ""  6 2 1 2147483647 1 "$INSTDIR\geai.exe" "" "" "EthereumAI" "" 40404 "" ""
  SimpleFC::AdvAddRule "Geai UDP discovery (UDP:40404)" "" 17 2 1 2147483647 1 "$INSTDIR\geai.exe" "" "" "EthereumAI" "" 40404 "" ""
