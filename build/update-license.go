...
var (
	...
	authorsFileHeader = "# This is the official list of go-ethereumai authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ethereumai Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-ethereumai"
	}
	if startOfSentence {
		return "The go-ethereumai library"
	}
	return "the go-ethereumai library"
}
