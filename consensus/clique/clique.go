...
// ecrecover extracts the EthereumAI account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the EthereumAI address
...
// EthereumAI testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     eaidb.Database       // Database to store and retrieve snapshot checkpoints
...
func New(config *params.CliqueConfig, db eaidb.Database) *Clique {
...
// Author implements consensus.Engine, returning the EthereumAI address recovered
