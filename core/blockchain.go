...
// Package core implements the EthereumAI consensus protocol.
package core
...
type BlockChain struct {
	...
	db     eaidb.Database // Low level persistent database to store final content in
...
// available in the database. It initialises the default EthereumAI Validator and
// Processor.
func NewBlockChain(db eaidb.Database, cacheConfig *CacheConfig, chainConfig *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config) (*BlockChain, error) {
	if cacheConfig == nil {
