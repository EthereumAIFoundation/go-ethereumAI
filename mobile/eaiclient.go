...
// Contains a wrapper for the EthereumAI client.
...
// EthereumAIClient provides access to the EthereumAI APIs.
type EthereumAIClient struct {
	client *eaiclient.Client
}

// NewEthereumAIClient connects a client to the given URL.
func NewEthereumAIClient(rawurl string) (client *EthereumAIClient, _ error) {
	rawClient, err := eaiclient.Dial(rawurl)
	return &EthereumAIClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *EthereumAIClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *EthereumAIClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *EthereumAIClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *EthereumAIClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *EthereumAIClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *EthereumAIClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *EthereumAIClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *EthereumAIClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *EthereumAIClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *EthereumAIClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *EthereumAIClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *EthereumAIClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *EthereumAIClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *EthereumAIClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *EthereumAIClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *EthereumAIClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *EthereumAIClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *EthereumAIClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *EthereumAIClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *EthereumAIClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *EthereumAIClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *EthereumAIClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *EthereumAIClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *EthereumAIClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *EthereumAIClient) SendTransaction(ctx *Context, tx *Transaction) error {
