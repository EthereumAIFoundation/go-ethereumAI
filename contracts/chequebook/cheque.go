...
// Package chequebook package wraps the 'chequebook' EthereumAI smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in etherai; (auto)cashing cheques in etherai
// as well as (auto)depositing etherai to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/ethereumai/go-ethereumai/contracts/chequebook/contract"
	...
	"github.com/ethereumai/go-ethereumai/swarm/services/swap/swap"
)
...
// * depositing etherai to the chequebook
// * watching incoming etherai
...
// Cash cashes the cheque by sending an EthereumAI transaction.
