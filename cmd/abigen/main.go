...
import (
	...
	"github.com/ethereumai/go-ethereumai/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the EthereumAI contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the EthereumAI contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the EthereumAI contract Solidity source to build and bind")
